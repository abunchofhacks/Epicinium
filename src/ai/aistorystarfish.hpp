...
class AIStoryStarfish : public AICommander
{
public:
	AIStoryStarfish(const Player& player, const Difficulty& difficulty,
		const std::string& rulesetname, char character);
	AIStoryStarfish(const AIStoryStarfish&) = delete;
	AIStoryStarfish(AIStoryStarfish&&) = delete;
	AIStoryStarfish& operator=(const AIStoryStarfish&) = delete;
	AIStoryStarfish& operator=(AIStoryStarfish&&) = delete;
	virtual ~AIStoryStarfish() = default;
