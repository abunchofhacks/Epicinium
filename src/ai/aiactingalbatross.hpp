...
class AIActingAlbatross : public AICommander
{
public:
	AIActingAlbatross(const Player& player, const Difficulty& difficulty,
		const std::string& rulesetname, char character);
	AIActingAlbatross(const AIActingAlbatross&) = delete;
	AIActingAlbatross(AIActingAlbatross&&) = delete;
	AIActingAlbatross& operator=(const AIActingAlbatross&) = delete;
	AIActingAlbatross& operator=(AIActingAlbatross&&) = delete;
	virtual ~AIActingAlbatross() = default;
