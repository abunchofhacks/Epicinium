...
class AIActingAlligator : public AICommander
{
public:
	AIActingAlligator(const Player& player, const Difficulty& difficulty,
		const std::string& rulesetname, char character);
	AIActingAlligator(const AIActingAlligator&) = delete;
	AIActingAlligator(AIActingAlligator&&) = delete;
	AIActingAlligator& operator=(const AIActingAlligator&) = delete;
	AIActingAlligator& operator=(AIActingAlligator&&) = delete;
	virtual ~AIActingAlligator() = default;
