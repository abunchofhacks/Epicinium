...
class AIActingAntilope : public AICommander
{
public:
	AIActingAntilope(const Player& player, const Difficulty& difficulty,
		const std::string& rulesetname, char character);
	AIActingAntilope(const AIActingAntilope&) = delete;
	AIActingAntilope(AIActingAntilope&&) = delete;
	AIActingAntilope& operator=(const AIActingAntilope&) = delete;
	AIActingAntilope& operator=(AIActingAntilope&&) = delete;
	virtual ~AIActingAntilope() = default;
