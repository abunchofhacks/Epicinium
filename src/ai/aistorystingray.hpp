...
class AIStoryStingray : public AICommander
{
public:
	AIStoryStingray(const Player& player, const Difficulty& difficulty,
		const std::string& rulesetname, char character);
	AIStoryStingray(const AIStoryStingray&) = delete;
	AIStoryStingray(AIStoryStingray&&) = delete;
	AIStoryStingray& operator=(const AIStoryStingray&) = delete;
	AIStoryStingray& operator=(AIStoryStingray&&) = delete;
	virtual ~AIStoryStingray() = default;
