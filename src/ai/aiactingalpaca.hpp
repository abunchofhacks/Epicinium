...
class AIActingAlpaca : public AICommander
{
public:
	AIActingAlpaca(const Player& player, const Difficulty& difficulty,
		const std::string& rulesetname, char character);
	AIActingAlpaca(const AIActingAlpaca&) = delete;
	AIActingAlpaca(AIActingAlpaca&&) = delete;
	AIActingAlpaca& operator=(const AIActingAlpaca&) = delete;
	AIActingAlpaca& operator=(AIActingAlpaca&&) = delete;
	virtual ~AIActingAlpaca() = default;
