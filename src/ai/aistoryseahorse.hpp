...
class AIStorySeahorse : public AICommander
{
public:
	AIStorySeahorse(const Player& player, const Difficulty& difficulty,
		const std::string& rulesetname, char character);
	AIStorySeahorse(const AIStorySeahorse&) = delete;
	AIStorySeahorse(AIStorySeahorse&&) = delete;
	AIStorySeahorse& operator=(const AIStorySeahorse&) = delete;
	AIStorySeahorse& operator=(AIStorySeahorse&&) = delete;
	virtual ~AIStorySeahorse() = default;
