...
class AIStorySaddlehead : public AICommander
{
public:
	AIStorySaddlehead(const Player& player, const Difficulty& difficulty,
		const std::string& rulesetname, char character);
	AIStorySaddlehead(const AIStorySaddlehead&) = delete;
	AIStorySaddlehead(AIStorySaddlehead&&) = delete;
	AIStorySaddlehead& operator=(const AIStorySaddlehead&) = delete;
	AIStorySaddlehead& operator=(AIStorySaddlehead&&) = delete;
	virtual ~AIStorySaddlehead() = default;
