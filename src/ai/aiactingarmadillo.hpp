...
class AIActingArmadillo : public AICommander
{
public:
	AIActingArmadillo(const Player& player, const Difficulty& difficulty,
		const std::string& rulesetname, char character);
	AIActingArmadillo(const AIActingArmadillo&) = delete;
	AIActingArmadillo(AIActingArmadillo&&) = delete;
	AIActingArmadillo& operator=(const AIActingArmadillo&) = delete;
	AIActingArmadillo& operator=(AIActingArmadillo&&) = delete;
	virtual ~AIActingArmadillo() = default;
