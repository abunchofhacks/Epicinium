...
class AIStorySandperch : public AICommander
{
public:
	AIStorySandperch(const Player& player, const Difficulty& difficulty,
		const std::string& rulesetname, char character);
	AIStorySandperch(const AIStorySandperch&) = delete;
	AIStorySandperch(AIStorySandperch&&) = delete;
	AIStorySandperch& operator=(const AIStorySandperch&) = delete;
	AIStorySandperch& operator=(AIStorySandperch&&) = delete;
	virtual ~AIStorySandperch() = default;
