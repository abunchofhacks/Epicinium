...
class AIActingAnchovies : public AICommander
{
public:
	AIActingAnchovies(const Player& player, const Difficulty& difficulty,
		const std::string& rulesetname, char character);
	AIActingAnchovies(const AIActingAnchovies&) = delete;
	AIActingAnchovies(AIActingAnchovies&&) = delete;
	AIActingAnchovies& operator=(const AIActingAnchovies&) = delete;
	AIActingAnchovies& operator=(AIActingAnchovies&&) = delete;
	virtual ~AIActingAnchovies() = default;
