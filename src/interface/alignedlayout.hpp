...
class AlignedLayout : public Layout
{
protected:
...
public:
	...
	virtual void align(HorizontalAlignment alignment) override { _halignment = alignment; }
	virtual void align(VerticalAlignment alignment) override { _valignment = alignment; }
};
